...
class DeleteGetVoice : Applier {
    override fun apply(bot: Bot, update: Update): ExecutionOutput? {
        if (update.callbackQuery != null){
            bot.sendMessage(ChatId.fromId(update.message!!.chat.id), "Your sticker has been deleted!")
            return ExecutionOutput(State.DELETE_GET_VOICE, update.callbackQuery!!.data)
        }
